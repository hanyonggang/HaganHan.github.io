...
/***/ function(module, exports, __webpack_require__) {
	...
	var _moWebgl = __webpack_require__(2);
	...
	var Fn3DScene = function () {
	        function Fn3DScene(eDivCanvasPar, eDivStatsPar) {
	                ...
	                this.jSettings = {
	                        ...
	                        nCanvasHeight: _hagan.hg.fnGetWindowHeight() - 4
	        ...
	        _createClass(Fn3DScene, [{
	                ...
	                value: function fnSetSprite() {
	                        ...
	                        for (var i = 0; i < 100; i++) {
	                                ...
	                                var oSprite = new THREE.Sprite(new THREE.SpriteCanvasMaterial({ color: Math.random() * 0x808080 + 0x808080, program: this.fnProgramStork }));
	                ...
	                value: function fnSetHover() {
	                        ...
	                        var oIntersected = null;

	                        _hagan.hg.fnAddEvent(window, "mousemove", function fnWindowMouseMove(evMouseMove) {

	                                oMouse.x = _moWebgl.moWebGl.fnGetNormalizationX(evMouseMove.clientX, _hagan.hg.fnGetWindowWidth());
	                                oMouse.y = _moWebgl.moWebGl.fnGetNormalizationY(evMouseMove.clientY, _hagan.hg.fnGetWindowHeight());
...
/***/ function(module, exports) {
	...
	var moWebGl = {
	    ...
	    //得到归一化的坐标X
	    fnGetNormalizationX: function fnGetNormalizationX(childX, parWidth) {
	        return childX / parWidth * 2 - 1;
	    },


	    //得到归一化的坐标Y
	    fnGetNormalizationY: function fnGetNormalizationY(childY, parHeight) {
	        return -(childY / parHeight) * 2 + 1;
	    }
	};

	exports.moWebGl = moWebGl;
