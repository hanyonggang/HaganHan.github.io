...
/***/ function(module, exports, __webpack_require__) {
	...
	var Fn3DRotate = function () {
	    function Fn3DRotate(eDivCanvasPar, eDivStatsPar) {
	        _classCallCheck(this, Fn3DRotate);
	    ...
	    _createClass(Fn3DRotate, [{
	        ...
	        value: function fnSetMesh() {
	            ...
	            for (var i = 0; i < geometry.faces.length; i += 2) {
	                ...
	                var sHexColor = Math.random() * 0xffffff;
	        ...
	        key: "fnSetPlane",
	        value: function fnSetPlane() {

	            var geometry = new THREE.PlaneBufferGeometry(20, 20);
	            geometry.rotateX(-Math.PI / 2);

	            var material = new THREE.MeshBasicMaterial({ color: 0xaaaaaa, overdraw: 0.5 });
	        ...
	        key: "fnSetMouseDown",
	        value: function fnSetMouseDown() {

	            var This = this;

	            _hagan.hg.fnAddEvent(window, "mousedown", function fnWindowMouseDown(evDown) {

	                var nDownX = _hagan.hg.fnGetClientX(evDown);

	                _hagan.hg.fnAddEvent(window, "mousemove", function fnWindowMouseMove(evMove) {

	                    This.nDifference = _hagan.hg.fnGetClientX(evMove) - nDownX;

	                    nDownX = _hagan.hg.fnGetClientX(evMove);
	                });
