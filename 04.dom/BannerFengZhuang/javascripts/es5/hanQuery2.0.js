...
Object.prototype.fnMovePerfection = function (json, endFn) {
    ...
    This.timer = setInterval(function () {
        ...
        for (var attr in json) {
            if (_typeof(json[attr]) != (typeof fnMovePerfection === 'undefined' ? 'undefined' : _typeof(fnMovePerfection))) {
                //解决json的原型链链向Object的bug
                var iCur = 0;
                if (attr == 'opacity') {
...
Object.prototype.fnGetNumInString = function (Boolean) {
    if (Boolean) {
        ...
        var _aArr = [];
        for (var _iNum = 0; _iNum < this.length; _iNum++) {
            if (this.charAt(_iNum) < "9" && this.charAt(_iNum) > "0") {
                _aArr.push(this.charAt(_iNum));
            }
        }
        return _aArr;
    }
